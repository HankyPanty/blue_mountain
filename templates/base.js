...
function showRules() {
	if (!rules_questions) {
		...
		element.innerHTML = element.innerHTML
			+"<div id='right_sixty'><div id='fifty_inner'><div id='center_inner_lifelines' style='padding-top:5%; opacity: 0; height: 50%; overflow: hidden'>"
				+"<img id='img_5050' src='/templates/kbc/5050.png' width='20%' height='30%'> "
				+"<img id='img_audpoll' src='/templates/kbc/audpoll.png' width='20%' height='30%'> "
				+"<img id='img_phone' src='/templates/kbc/flip.png' width='20%' height='30%'> "
		...
		element.innerHTML = element.innerHTML
			+"<div id='bottom_fifty'>"
				+"<div id='top_fourty'><center style='position:relative;'><img src='/templates/kbc/template_black.png' width='70%' height = '100%'><div id='text_question_and_options'><div id='text_vertical_center'><div id='question'></div></div></div></center></div>"
				+"<div id='bottom_sixty'>"
					+"<div id='left_fifty'><center><br>"
						+"<div id='text_question_and_options'><div id='text_option_a'>A</div></div>"
						+"<div id='text_question_and_options'><div id='text_option_c'>C</div></div>"
					...
					+"<div id='right_fifty'><center><br>"
						+"<div id='text_question_and_options'><div id='text_option_b'>B</div></div>"
						+"<div id='text_question_and_options'><div id='text_option_d'>D</div></div>"
...
document.onkeypress = function(key) {
	if (!started) {
		...
		if (!question_displayed) {
			...
			if (key.which == 13) { // enter pressed, check if previous key was valid.
				if (!locked) {
	...
	} else if (prev_key == 110 && key.which == 13) {
